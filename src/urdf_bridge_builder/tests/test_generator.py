...
<robot name="test_robot">
  <link name="base_link"/>
  <bridge ros_topic="/joint_states" gz_topic="/model/test_robot/joint_states" type="sensor_msgs/msg/JointState" direction="gz_to_ros"/>
  <bridge ros_topic="/cmd_vel" gz_topic="/model/test_robot/cmd_vel" type="geometry_msgs/msg/Twist" direction="ros_to_gz"/>
  <link name="end_effector"/>
  <bridge ros_topic="/feedback" gz_topic="/model/test_robot/feedback" type="std_msgs/msg/String" direction="bidirectional"/>
</robot>
"""
...
<robot name="test_robot">
  <link name="base_link"/>
  <bridge ros_topic="/joint_states" gz_topic="/model/test_robot/joint_states" type="sensor_msgs/msg/JointState"/> <!-- Missing direction -->
</robot>
"""
...
def test_parse_bridge_tag_success():
    ...
    bridge_element = ET.fromstring('<bridge ros_topic="/test" gz_topic="/gz_test" type="std_msgs/msg/String" direction="ros_to_gz"/>')
    config = core.parse_bridge_tag(bridge_element)
    assert config.ros_topic == "/test"
    assert config.gz_topic == "/gz_test"
    assert config.msg_type == "std_msgs/msg/String"
...
def test_parse_bridge_tag_missing_attribute():
    ...
    bridge_element = ET.fromstring('<bridge ros_topic="/test" gz_topic="/gz_test" type="std_msgs/msg/String"/>') # Missing direction
...
def test_generate_bridge_yaml():
    ...
    bridge_configs = [
        core.BridgeConfig("/joint_states", "/model/test_robot/joint_states", "sensor_msgs/msg/JointState", "gz_to_ros"),
        core.BridgeConfig("/cmd_vel", "/model/test_robot/cmd_vel", "geometry_msgs/msg/Twist", "ros_to_gz"),
    ]
